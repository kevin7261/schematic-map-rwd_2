/**
 * 座標正規化圖層（json_grid_coord_normalized_sn2）：自 OSM→GeoJSON→JSON 父圖層鏡像 dataJson／重置管線欄位／persist。
 * 與 {@link ../osm_2_geojson_2_json_sn2/index.js} 分檔對齊，store 僅注入 findLayerById／saveLayerState。
 */

import { LAYER_ID as OSM_2_GEOJSON_2_JSON_LAYER_ID } from '../osm_2_geojson_2_json_sn2/sessionOsmXml.js';
 ...
 * 供 JSON 檢視與下游 `point_orthogonal_sn2` 鏡像讀取。
 */
