/**
 * Control 分頁：版面網絡網格／版面網絡網格_2 家族（layout_network_grid_from_vh_draw*）
 ...
 * }} opts
 */
export function useLayoutNetworkGridFromVhDrawControlTab({ dataStore, pickOrthogonalVhDrawLocalJsonClick }) {
