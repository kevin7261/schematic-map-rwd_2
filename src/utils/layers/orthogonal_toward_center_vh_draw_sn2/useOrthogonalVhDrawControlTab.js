...
const VH_DRAW_LOCAL_JSON_INPUT_ID = 'orthogonal-vh-draw-local-json-input-sn2';
 ...
 * }} opts
 */
export function useOrthogonalVhDrawControlTabSn2({
  dataStore,
  isExecuting,
  applyJsonGridFromCoordBestMoveSegmentsToLayer,
  ...
  const downloadOrthogonalVhDrawControlTabJson = () => {
    ...
    try {
      ...
      a.href = url;
      a.download = 'orthogonal_toward_center_vh_draw_sn2_control.json';
