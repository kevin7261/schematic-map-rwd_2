...
<script>
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      /** l3／m3 Upper 子元件綁定：對應測試_4 之 taipei_sn4_l／taipei_sn4_m */
      const upperL3BoundLayerId = computed(() => 'taipei_sn4_l');
      const upperM3BoundLayerId = computed(() => 'taipei_sn4_m');
...
<template>
  <div class="d-flex flex-column h-100 overflow-hidden">
    ...
    <div class="flex-grow-1 overflow-auto">
      ...
      <div
        v-show="activeUpperTab === 'network-draw-lines-sn4'"
        ref="networkDrawSn4ContainerRef"
        class="h-100"
      >
        <NetworkDrawTabSn4
