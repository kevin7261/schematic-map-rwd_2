...
<script>
  ...
  import SpaceLayoutGridViewerTab from '../tabs/SpaceLayoutGridViewerTab.vue';
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      /** dataJson 路段 D3 平面示意 */
      const SpaceLayoutGridViewerTabRef = ref(null);
      ...
      watch(
        ...
        (newTab) => {
          ...
          if (newTab === 'd3js') {
            ...
            nextTick(() => {
              setTimeout(() => {
                if (SpaceLayoutGridViewerTabRef.value?.resize) {
                  SpaceLayoutGridViewerTabRef.value.resize();
                }
              }, 100);
            });
      ...
      watch([() => props.mainPanelWidth, () => props.contentHeight], () => {
        nextTick(() => {
          ...
          if (SpaceLayoutGridViewerTabRef.value && SpaceLayoutGridViewerTabRef.value.resize) {
            SpaceLayoutGridViewerTabRef.value.resize();
          }
        });
      });
...
<template>
  <div class="d-flex flex-column h-100 overflow-hidden">
    ...
    <div class="flex-grow-1 overflow-auto">
      ...
      >
        <SpaceLayoutGridViewerTab
          ref="SpaceLayoutGridViewerTabRef"
          class="flex-grow-1 d-flex flex-column"
          :container-height="contentHeight"
          @active-layer-change="handleActiveLayerChange"
        />
