...
<script>
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      /** l3／m3 Upper 子元件綁定：測試_4 為 taipei_sn4_l／sn4_m，其餘沿用原 id */
      const upperL3BoundLayerId = computed(() =>
        activeUpperLayerId.value === 'taipei_sn4_l' ? 'taipei_sn4_l' : 'taipei_l3'
      );
      const upperM3BoundLayerId = computed(() =>
        activeUpperLayerId.value === 'taipei_sn4_m' ? 'taipei_sn4_m' : 'taipei_m3'
      );
      ...
      return {
        ...
        LayoutGridTab_Test2, // 版面網格測試_2組件引用
        ...
        layoutGridTest2ContainerRef, // 版面網格測試_2容器引用
  ...
  <div class="d-flex flex-column h-100 overflow-hidden">
    ...
    <div class="d-flex justify-content-start my-bgcolor-gray-200 p-3">
      <div class="d-flex align-items-center rounded-pill shadow my-blur gap-1 p-2">
        ...
        <!-- 📄 版面網格測試_2按鈕 (Layout Grid Test2 Button) -->
        <button
          class="btn rounded-circle border-0 d-flex align-items-center justify-content-center my-btn-transparent my-font-size-xs"
          :class="{
